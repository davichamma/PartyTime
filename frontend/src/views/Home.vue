        ...
        async getParties() {
            ...
            .then((data) => {
                ...
                data.parties.forEach((party, index) => {
                    ...
                    if(party.partyDate) {
                        party.partyDate = new Date(party.partyDate);
                        let minutes = party.partyDate.getTimezoneOffset();
                        let d = new Date(party.partyDate.setMinutes(party.partyDate.getMinutes() + minutes));
...
<style scoped>
    ...
    #party-1 {
        background-image: url('C:\Users\estagio.sst22\Documents\PartyTime\frontend\public\img\party1.jpg');
    }

    #party-2 {
        background-image: url('C:\Users\estagio.sst22\Documents\PartyTime\frontend\public\img\party2.jpg');
    }

    #party-3 {
        background-image: url('C:\Users\estagio.sst22\Documents\PartyTime\frontend\public\img\party3.jpg');
    }

    #party-4 {
        background-image: url('C:\Users\estagio.sst22\Documents\PartyTime\frontend\public\img\party4.jpg');
    }
