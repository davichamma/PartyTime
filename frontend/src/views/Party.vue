    ...
    <div class="party">
      ...
      <div class="party-container">
        ...
        <div class="party-details">
          ...
          <p class="partyDate">{{ party.partyDate }}</p>        
        </div>
      </div>
    </div>
  </template>
      ...
      methods: {
          async getParty() {
              ...
              .then((data) => {
                  ...
                  this.party.partyDate = new Date(this.party.partyDate)
                  let minutes = this.party.partyDate.getTimezoneOffset();
                  let d = new Date(this.party.partyDate.setMinutes(this.party.partyDate.getMinutes() + minutes));
