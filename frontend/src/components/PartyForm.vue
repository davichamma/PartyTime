<template>
    <div>
        ...
        <form id="register-form" enctype="multipart/form-data" @submit="page === 'newparty' ? createParty($event) : update($event)">
            ...
            <div class="input-container">
                <label for="partyDate">Data da Festa:</label>
                <input type="date" id="partyDate" name="partyDate" v-model="partyDate">
            </div>
            <div class="input-container">
...
export default {
  ...
  methods: {
      async createParty(e) {
        ...
        formData.append('partyDate', this.partyDate);
